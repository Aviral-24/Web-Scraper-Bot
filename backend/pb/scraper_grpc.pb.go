...
const (
	ScraperService_RunScrape_FullMethodName = "/scraper.ScraperService/RunScrape"
)
...
type ScraperServiceClient interface {
	RunScrape(ctx context.Context, in *ScrapeRequest, opts ...grpc.CallOption) (*ScrapeResponse, error)
}
...
func (c *scraperServiceClient) RunScrape(ctx context.Context, in *ScrapeRequest, opts ...grpc.CallOption) (*ScrapeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ScrapeResponse)
	err := c.cc.Invoke(ctx, ScraperService_RunScrape_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ScraperServiceServer interface {
	RunScrape(context.Context, *ScrapeRequest) (*ScrapeResponse, error)
...
func (UnimplementedScraperServiceServer) RunScrape(context.Context, *ScrapeRequest) (*ScrapeResponse, error) {
...
func _ScraperService_RunScrape_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ScrapeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ScraperServiceServer).RunScrape(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ScraperService_RunScrape_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ScraperServiceServer).RunScrape(ctx, req.(*ScrapeRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _ScraperService_RunScrape_Handler,
		},
	},
